...
const CreateNewFlashCard = ({ title, setTitle, description, setDescription, saveFlashCard, mode, setMode }) => {
                ...
                <Card>
                        ...
                        <CardActions>
                                <Stack direction="row" spacing={2}>
                                        <Button variant="contained" onClick={saveFlashCard}>Save</Button>
